const targetLink = document.querySelector('.travel-agency a');
targetLink.addEventListener(
	'click',
	(event) => {
...
const dotsParrent = document.querySelector('.travel-agency');
